		...
		<div id="top-container" class="container">
			...
			<div class="row">
				<div class="col-xl-8">
					...
					<div class="panel panel-body p-3">
						<div class="row">
							<div class="col-xl-6">
								<!-- 선택된 지역의 추천수가 많은 테이블 ---------------------------------------------------------------------------------------------->
								<table class="table table-hover cardview best-table"
									...
									<tbody>
										<c:forEach items="${locationlist}" var="board" begin="0"
											end="2" step="1" varStatus="i">
											<tr>
												<td>[<c:out value="${board.location}" />]
												</td>
												<td><a class='move smallList'
													href='<c:out value="${board.bno}"/>'><c:out
															value="${board.title}" /></a> <b>[<c:out
															value="${board.reply_count}" />]
												</b></td>
												<td><i class="far fa-thumbs-up"></i> <c:out
														value="${board.like_count}" /></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
							...
							<div class="col-xl-6">
								...
								<table class="table table-hover cardview best-table"
									...
									<tbody>
										<c:forEach items="${locationlist}" var="board" begin="3"
											end="5" step="1" varStatus="i">
											<tr>
												<td>[<c:out value="${board.location}" />]
												</td>
												<td style="width: 20%;"><a class='move smallList'
													href='<c:out value="${board.bno}" />'><c:out
															value="${board.title}" /></a> <b>[<c:out
															value="${board.reply_count}" />]
												</b></td>
				...
				<div class="col-xl-4">
					<div class="panel panel-default ">
						<h4 style="color:#ddd;" class="panel-heading pb-3">서울전체 인기 소식(삭제 예정)</h4>
					</div>
						...
						<div class="row">
							<div class="col-xl-12">
								...
								<table class="table table-hover cardview best-table"
									id="dataTables-example">
									<tbody>
										<c:forEach items="${locationlist}" var="board" begin="6"
											end="9" step="1" varStatus="i">
											<tr>
												<td>[<c:out value="${board.location}" />]
												</td>
												<td><a class='move smallList'
